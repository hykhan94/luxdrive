        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          {["Vehicle", "Details", "Payment"].map((step, index) => (
            <div key={step} className="flex items-center gap-2">
              ...
              <span className={index === 0 ? "text-white" : "text-neutral-500"}>
                {step}
              </span>
              {index < 2 && (
                <div
                  className={`w-12 h-0.5 ${index === 0 ? "bg-[#C9A961]" : "bg-neutral-800"}`}
                />
              )}
            </div>
          ))}
            ...
            {vehicles.map((vehicle) => (
              ...
              >
                ...
                <div className="p-4 bg-[#141414]">
                  {/* Model */}
                  <p
                    className={`text-[10px] font-semibold tracking-wider mb-1 ${vehicle.isElectric ? "text-green-400" : "text-[#C9A961]"}`}
                  >
                    {vehicle.model}
                  </p>
                  ...
                  <div className="flex items-center gap-4 mb-3 text-sm text-neutral-400">
                    <span className="flex items-center gap-1.5">
                      <Users
                        className={`w-4 h-4 ${vehicle.isElectric ? "text-green-400" : "text-[#C9A961]"}`}
                      />
