// ============================================
// apps/web/lib/partner-profile-fields.ts
// Partner profile's editable fields (the per-portal data for autosave).
...
export const PARTNER_PROFILE_FIELDS: ProfileFieldConfig[] = [
  // --- Company (10) ---
  {
    key: "companyName",
    group: "company",
...
export const PARTNER_FIELD_BY_KEY = buildFieldMap(PARTNER_PROFILE_FIELDS);
