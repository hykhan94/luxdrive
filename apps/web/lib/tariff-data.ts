...
export const VEHICLE_CLASSES: {
  ...
  {
    id: "coaster",
    name: "Coaster 23-Seater",
    category: "group",
    maxPassengers: 23,
  },
  {
    id: "kinglong",
    name: "King Long 49-Seater",
    category: "group",
    maxPassengers: 49,
  },
  {
    id: "electric-luxury-sedan",
    name: "Electric",
    category: "ev",
...
export const DISPLAY_VEHICLE_CLASSES = VEHICLE_CLASSES.filter(
  (v) => v.category !== "ev",
);
...
export const RIYADH_ONEWAY_ROUTES: TariffRoute[] = [
  ...
  { id: "ruh-city-sanaiya", pickup: "Riyadh City", dropoff: "Sanaiya" },
  {
    id: "ruh-city-sabic",
    pickup: "Riyadh City",
    dropoff: "SABIC Headquarters",
  },
  {
    id: "ruh-city-diplomatic",
    pickup: "Riyadh City",
    dropoff: "Diplomatic City",
  },
  ...
  {
    id: "ruh-city-boulevard",
    pickup: "Riyadh City",
    dropoff: "Riyadh Boulevard",
  },
  { id: "ruh-city-ricec", pickup: "Riyadh City", dropoff: "RICEC" },
  {
    id: "ruh-city-namar",
    pickup: "Riyadh City",
    dropoff: "Wadi Namar Water Fall",
  },
  ...
  {
    id: "ruh-city-55-100km",
    pickup: "Riyadh City",
    dropoff: "55 KM till 100 KM",
    isPerKm: true,
  },
  {
    id: "ruh-city-kapark",
    pickup: "Riyadh City",
    dropoff: "King Abdullah Park",
  },
  { id: "ruh-city-hanifah", pickup: "Riyadh City", dropoff: "Wadi Hanifah" },
  {
    id: "ruh-city-diriyah",
    pickup: "Riyadh City",
    dropoff: "Historic Diriyah",
  },
...
export const RIYADH_HOURLY_ROUTES: TariffRoute[] = [
  {
    id: "ruh-hourly-6-8",
    pickup: "Riyadh",
    dropoff: "6-8 Hours (Day Rate)",
    isHourly: true,
  },
  {
    id: "ruh-extra-hour",
    pickup: "Riyadh",
    dropoff: "Extra Hour (After 8 Hours)",
    isExtraHour: true,
  },
  {
    id: "ruh-per-hour",
    pickup: "Riyadh",
    dropoff: "Per Hour Rate",
    isHourly: true,
  },
];
...
export const JEDDAH_ONEWAY_ROUTES: TariffRoute[] = [
  {
    id: "jed-city-kaaia",
    pickup: "Jeddah City",
    dropoff: "KAAIA Saudi Terminal",
  },
  {
    id: "jed-city-indigo",
    pickup: "Jeddah City",
    dropoff: "Indigo Beach Resort",
  },
  {
    id: "jed-indigo-roundtrip",
    pickup: "Jeddah",
    dropoff: "Round Trip Indigo Beach Resort",
  },
  { id: "jed-airport-makkah", pickup: "Jeddah Airport", dropoff: "Makkah" },
  { id: "jed-city-makkah", pickup: "Jeddah City", dropoff: "Makkah" },
  {
    id: "jed-makkah-terminal",
    pickup: "Makkah",
    dropoff: "Jeddah (Intl Terminal)",
  },
  ...
  {
    id: "jed-terminal-madinah",
    pickup: "Jeddah (All Terminals)",
    dropoff: "Madinah",
  },
  ...
  {
    id: "jed-pointab",
    pickup: "Drop Off Point A",
    dropoff: "Point B in Jeddah",
  },
...
function generatePrices(routeId: string, economyPrice: number): TariffPrice[] {
  return [
    { routeId, vehicleClass: "economy-sedan", price: economyPrice },
    {
      ...
      price: Math.round(economyPrice * 1.35),
    },
    {
      routeId,
      vehicleClass: "first-class",
      price: Math.round(economyPrice * 2.3),
    },
    {
      routeId,
      vehicleClass: "business-suv",
      price: Math.round(economyPrice * 1.85),
    },
    { routeId, vehicleClass: "hiace", price: Math.round(economyPrice * 2.7) },
    { routeId, vehicleClass: "coaster", price: Math.round(economyPrice * 4) },
    {
      routeId,
      vehicleClass: "kinglong",
      price: Math.round(economyPrice * 5.7),
    },
  ];
}
...
export const RIYADH_EV_PRICES: TariffPrice[] = [
  ...RIYADH_ONEWAY_ROUTES.map((route) => {
    const firstClassPrice =
      RIYADH_ONEWAY_PRICES.find(
        (p) => p.routeId === route.id && p.vehicleClass === "first-class",
      )?.price || 350;
    return {
      routeId: route.id,
      vehicleClass: "electric-luxury-sedan" as VehicleClass,
      price: firstClassPrice,
    };
  }),
  ...RIYADH_HOURLY_ROUTES.map((route) => {
    const firstClassPrice =
      RIYADH_HOURLY_PRICES.find(
        (p) => p.routeId === route.id && p.vehicleClass === "first-class",
      )?.price || 1400;
    return {
      routeId: route.id,
...
export function getOnewayRoutes(city: City): TariffRoute[] {
  switch (city) {
    case "riyadh":
      return RIYADH_ONEWAY_ROUTES;
    case "jeddah":
      return JEDDAH_ONEWAY_ROUTES;
    case "makkah":
      return MAKKAH_ONEWAY_ROUTES;
    case "madinah":
      return MADINAH_ONEWAY_ROUTES;
  }
}
...
export function getHourlyRoutes(city: City): TariffRoute[] {
  switch (city) {
    case "riyadh":
      return RIYADH_HOURLY_ROUTES;
    case "jeddah":
      return JEDDAH_HOURLY_ROUTES;
    case "makkah":
      return MAKKAH_HOURLY_ROUTES;
    case "madinah":
      return MADINAH_HOURLY_ROUTES;
  }
}
...
export function getBookableRoutes(
  ...
  const routes =
    routeType === "oneway" ? getOnewayRoutes(city) : getHourlyRoutes(city);
...
export function getOnewayPrices(city: City): TariffPrice[] {
  switch (city) {
    case "riyadh":
      return RIYADH_ONEWAY_PRICES;
    case "jeddah":
      return JEDDAH_ONEWAY_PRICES;
    case "makkah":
      return MAKKAH_ONEWAY_PRICES;
    case "madinah":
      return MADINAH_ONEWAY_PRICES;
  }
}
...
export function getHourlyPrices(city: City): TariffPrice[] {
  switch (city) {
    case "riyadh":
      return RIYADH_HOURLY_PRICES;
    case "jeddah":
      return JEDDAH_HOURLY_PRICES;
    case "makkah":
      return MAKKAH_HOURLY_PRICES;
    case "madinah":
      return MADINAH_HOURLY_PRICES;
  }
}
...
export function getPrice(
  ...
  let found = onewayPrices.find(
    (p) => p.routeId === routeId && p.vehicleClass === vehicleClass,
  );
  if (found) return found.price;

  // Check hourly prices
  const hourlyPrices = getHourlyPrices(city);
  found = hourlyPrices.find(
    (p) => p.routeId === routeId && p.vehicleClass === vehicleClass,
  );
  return found?.price || null;
}

export function getAllPricesForRoute(
  city: City,
  routeId: string,
...
export function calculateVATBreakdown(totalPrice: number): {
  baseFare: number;
  vat: number;
  total: number;
} {
