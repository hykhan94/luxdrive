// TODO(shared-profile): Duplicated from components/partner/profile/partner-profile-documents.tsx
// Portal-specific bits: partnerApi → vendorApi (uploadDocument, uploadMou call sites).
// Consolidate into components/shared/profile/ once both flows are stable.

"use client";

// ============================================
// apps/web/components/vendor/profile/vendor-profile-documents.tsx
...
import {
  DocumentUploadCard,
  type DocumentItem,
} from "@/components/vendor/profile/document-upload-card";
...
import {
  ...
  type FlagSource,
} from "@/components/vendor/profile/rejection-progress-context";
...
export interface VendorProfileDocumentsProps {
  profileId: string;
  editable: boolean;
  status: string;
...
// state after the vendor replaces the file: we've had reports that vendors
...
function FlagBanner({
  ...
  const isVendorRequest = source === "partner_request";
...
export function VendorProfileDocuments({
  profileId,
  editable,
  status,
  documents,
  ...
  // — vendor-request items are intentional edits, not outstanding corrections.
      ...
      >
        <div className="grid gap-3 md:grid-cols-2">
          {documents.map((doc) => {
            ...
            // Lock rules mirror fields: informational flags (vendor-request
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  // vendor immediately sees which docs need attention.
      ...
      >
        ...
        >
          ...
          <DocumentUploadCard
            ...
            onView={(d: DocumentItem) => onView(d)}
          />
