// ============================================
// !!! DESTINATION PATH: apps/web/components/landing/footer.tsx
// ============================================
"use client";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            {/* Social Icons — sourced from the shared luxdriveSocials
                list so contact page + footer stay in lockstep. Edit
                apps/web/lib/social-icons.tsx to add/remove networks. */}
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start justify-center md:justify-start gap-3 text-gray-400">
                <MapPin className="w-10 h-10 text-[#C9A961] mt-0.5" />
                <span className="text-sm">
                  Level 7, Building 4.07, King Abdullah Financial District,
                  Riyadh, Saudi Arabia
                </span>
              </li>
              <li className="flex items-center justify-center md:justify-start gap-3 text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-xs">
              &copy; 2026 LuxDrive by Luxakari Hospitality Group. All rights
              reserved.
            </p>
