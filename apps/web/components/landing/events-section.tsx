      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Book for{' '}
              <span className="text-[#C9A961]">Special Events</span>
            </h2>
            ...
            >
              Make your special moments unforgettable with our premium fleet and professional chauffeurs. 
              We offer custom packages tailored to your event needs, ensuring seamless transportation 
            ...
            >
              <a
                href="https://wa.me/966500000000?text=Hello%2C%20I%27d%20like%20to%20inquire%20about%20event%20transportation"
                target="_blank"
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              <div className="p-6 bg-[#141414]/80 backdrop-blur-sm rounded-xl border border-[#C9A961]/20 text-center">
                <div className="text-4xl font-serif font-bold text-[#C9A961] mb-2">500+</div>
                <div className="text-gray-400 text-sm">Events Served</div>
              </div>
              <div className="p-6 bg-[#141414]/80 backdrop-blur-sm rounded-xl border border-[#C9A961]/20 text-center">
                <div className="text-4xl font-serif font-bold text-[#C9A961] mb-2">50+</div>
                <div className="text-gray-400 text-sm">Fleet Vehicles</div>
              </div>
              <div className="p-6 bg-[#141414]/80 backdrop-blur-sm rounded-xl border border-[#C9A961]/20 text-center">
                <div className="text-4xl font-serif font-bold text-[#C9A961] mb-2">100%</div>
                <div className="text-gray-400 text-sm">Satisfaction Rate</div>
              </div>
              <div className="p-6 bg-[#141414]/80 backdrop-blur-sm rounded-xl border border-[#C9A961]/20 text-center">
                <div className="text-4xl font-serif font-bold text-[#C9A961] mb-2">24/7</div>
