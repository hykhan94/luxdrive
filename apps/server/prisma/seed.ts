...
async function main() {
  ...
  // Delete existing tariffs and create fresh
  ...
  const tariffs = [
    {
      ...
      hours: null,
      vehicleClass: "ECONOMY_SEDAN" as const,
      price: 150,
    },
    {
      city: "RIYADH" as const,
      ...
      route: "Airport to City",
      hours: null,
      vehicleClass: "BUSINESS_SEDAN" as const,
      price: 250,
    },
    {
      city: "RIYADH" as const,
      ...
      route: "Airport to City",
      hours: null,
      vehicleClass: "BUSINESS_SUV" as const,
      price: 350,
    },
    {
      city: "RIYADH" as const,
      ...
      route: "Airport to City",
      hours: null,
      vehicleClass: "FIRST_CLASS" as const,
      price: 600,
    },
    {
      city: "RIYADH" as const,
